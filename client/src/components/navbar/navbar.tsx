...
const Navbar = () => {
	...
	return (
		...
		>
			...
			<div id="Sidebar-menu">
				<ButtonLink to={encryptedPath("/home")} activeClass={getButtonClass("/home")} tooltipContent="หน้าหลัก">
				...
				<ButtonLink to={encryptedPath("/Records")} activeClass={getButtonClass("/Records")} tooltipContent="บันทึกข้อมูล RFID">
				...
				<ButtonLink to={encryptedPath("/scans")} activeClass={getButtonClass("/scans")} tooltipContent="รายชื่อผู้ไม่ออกจากระบบ">
				...
				<ButtonLink to={encryptedPath("/footage")} activeClass={getButtonClass("/footage")} tooltipContent="ฟุตเทจของเหตุการณ์ผิดปกติ">
