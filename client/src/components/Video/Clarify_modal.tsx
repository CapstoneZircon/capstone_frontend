...
const ClarifyModal: FC<ClarifyModalProps> = ({ showModal, closeModal }) => {
                            ...
                            <div className="flex items-start">
                                <div>
                                    ...
                                    <div className="mt-2 w-96 h-auto">
                                        ...
                                        <textarea id="story" name="story" rows={7}  cols={43} className='border-[1px] border-gray-400 rounded-lg w-96 resize-none p-2'/>
                                    </div>
                                    <div className="mt-2  ">
                                        <p className="text-sm text-gray-500">
                                            Password 
